...
selected_variable = "spin transition-induced density anomaly"
...
if data is None:
    ...
    if temperature_array is None:
        ...
        '''min_temp, max_temp = -200, 200  # Shrink the range
        ...
        # Step 10: Apply a transformation to rotate the dataset
